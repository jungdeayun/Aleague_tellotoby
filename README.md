...
- **이미지 전처리**
 ...
 6. [imfill](https://kr.mathworks.com/help/images/ref/imfill.html)을 사용하기 위해 첫 행과 마지막 행을 1로 바꿈 (*그림 4번 참고)
 7. imfill한 이미지와 하지 않은 이미지를 비교해 바뀐 부분을 1으로 바뀌지 않은 부분을 0으로 하여 링 구멍 인식 (*그림 4번 참고)
