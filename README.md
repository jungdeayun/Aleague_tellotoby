...
**저희 팀의 전략은**
상하좌우의 픽셀 수를 비교해 이동하여 초록색 링을 인식하게 하여 구멍을 찾은 뒤, 드론 영상 크기의 중심점과 드론 영상의 링 구멍의 중심점의 차이를 계산하여 통과하도록 합니다.
빨간색 점과 파란색 점도 똑같이 픽셀 수를 이용해 90도 회전 또는 착지하도록 합니다. 만약 점을 지나치거나 못 찾았을 경우에는 후진하여 다시 찾도록 합니다.
...
![알고리즘 영상](/readmeFile/알고리즘 영상.png)
